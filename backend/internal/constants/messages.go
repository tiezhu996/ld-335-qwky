...
const (
	...
	MsgReconciliationCaliber  = "口径：冲正单已从总笔数/总金额/成功笔数剔除，历史结算查询仍保留"
	...
	MsgReverseNotSettled      = "结算单（SettlementOrder）非已结算状态，禁止冲正"
	MsgReverseDuplicated      = "结算单（SettlementOrder）已冲正，返回首次冲正结果"
